...
Для обслуживания приёмника геопозиционирования нужен [gpsd](https://gpsd.io/).
...
### Геопозиционирование
Предполагается, что обслуживание приёмника ГПС осуществляется gpsd. Установка и настройка gpsd описана на [сайте проекта](https://gpsd.io/). При необходимости в файле  _params.php_ можно указать фактический адрес и порт демона, если они отличаются от умолчальных.
