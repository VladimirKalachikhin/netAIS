[In English](https://github.com/VladimirKalachikhin/netAIS/blob/master/README.md)  
...
Собственные координаты программное обеспечение получает от [gpsd](https://gpsd.io/), [gpsdPROXY](https://github.com/VladimirKalachikhin/gpsdPROXY) или [Signal K](https://signalk.org/).
